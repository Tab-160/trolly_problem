...
<html>
	...
	<body>
		<h1>Question 7</h1>
		<div class="image">
			<img src="../img/q7.jpg" style="width: 50vw;">
		</div>
		<p>You Did Nothing!</p>
		<?php
			...
			pg_query($dbconn, "INSERT INTO questions(q_num, name, pulled_lever) VALUES (7, '$name', false);");

			pg_close($dbconn);
		?>
		<div class="options">
			<button onclick="location.href='../q8';">Next Question</button>
		</div>
	</body>
</html>