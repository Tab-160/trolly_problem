			  ...
			  ['Sleep',    7]
				...
				var data = google.visualization.arrayToDataTable([
					...
					<?php
						...
						$num_pulled_query = pg_query($dbconn, "SELECT COUNT(name) FROM questions WHERE q_num=3 AND pulled_lever=true");
						$num_not_pulled_query = pg_query($dbconn, "SELECT COUNT(name) FROM questions WHERE q_num=3 AND pulled_lever=false");
