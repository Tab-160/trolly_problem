...
<html>
			  ...
			  ['Sleep',    7]
				...
				var data = google.visualization.arrayToDataTable([
					...
					<?php
						...
						$num_pulled_query = pg_query($dbconn, "SELECT COUNT(name) FROM questions WHERE q_num=8 AND pulled_lever=true");
						$num_not_pulled_query = pg_query($dbconn, "SELECT COUNT(name) FROM questions WHERE q_num=8 AND pulled_lever=false");
	...
	<body>
		<h1>Question 8</h1>
		<div class="image">
			<img src="../../img/q8.jpg" style="width: 50vw;">
		</div>
		<div class="piechart">
		...
		<br>
		<div class="options">
			<button onclick="location.href='../q9/';">Next Question</button>
		</div>
	</body>
</html>